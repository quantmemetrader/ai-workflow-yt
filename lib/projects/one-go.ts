...
export type OneGoResult =
  | { ok: true; brought: number; way: "director" | "assembled"; seconds?: number; videoProjectId: string }
 ...
 */
export async function oneGo(viewer: Viewer, projectId: string, body: { prompt?: unknown; way?: unknown } = {}): Promise<OneGoResult> {
