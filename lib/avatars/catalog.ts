 ...
 *   pixel      - 16x16 pixel people drawn for this app in the same grid and
 *                palette as the AI employees' faces (`lib/agents/pixel.ts`), so
 *                a person who wants to can match the employees.
 *
...
export type AvatarStyle = "notionists" | "lorelei" | "pixel";
...
export const AVATAR_STYLES: readonly AvatarStyleInfo[] = [
  ...
  },
  {
    ...
    en: "Pixel",
    count: 8,
    credit: "Drawn for this app, after the AI employees' pixel faces",
    licence: { name: "Original to this app", url: "/avatars/LICENSES.md" },
    licenceZh: "本应用原创",
    source: "lib/agents/pixel.ts",
  },
];
